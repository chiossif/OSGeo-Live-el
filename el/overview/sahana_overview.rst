...
Παρέχει εργαλεία συνεργασίας βασισμένα στο διαδίκτυο τα οποία χρησιμοποιούνται για επίλυση των κοινών προβλημάτων προσανατολισμού τα οποία αντιμετωπίζονται κατά τη διάρκεια μιας καταστροφής, συμπεριλαμβανομένης της εύρεσης χαμένων ανθρώπων, τη διαχείριση βοήθειας, 
...
Λύσεις είναι διαθέσιμες για διαχείριση Καταστροφών, Διαχείριση Επειγόντων περιστατικών, Ανάπτυξη, Ανθρωπιστικούς και Περιβαλλοντικούς τομείς. Ελεύθερο και ανοιχτό λογισμικό σημαίνει πως είναι εύκολα τυποποιήσιμο και επεκτάσιμο. Το Sahana Eden μπορεί επίσης να integrate με άλλες λύσεις και να παρέχει μια διεπιφάνεια διαχείρισης/ticketing γύρω από δεδομένα crowd-sourced data - όπως είναι αυτά που συλλέγονται από την χαρτογραφική εφαρμογή Ushahidi incident mapping application. 
...
* Διαχείριση εθελοντών - Διαχειρίζεται τους εθελοντές capturing τις ικανότητές τους, τη διαθεσιμότητα και την allocation.
* Αγνοούμενων ανθρώπων Registry - Αναφορά και αναζήτηση για αγνοούμενα άτομα.
* Αναγνώριση θυμάτων Καταστροφών.
* Καταφυγίου Registry - Εντοπίζει την τοποθεσία, κατανομή, δυνατότητα και breakdown των θυμάτων σε καταφύγια.
* Σύστημα διαχείρισης Νοσοκομείων - Τα Νοσοκομεία μπορούν να μοιράζουν πληροφορίες on resources & needs.
* Οργάνωσης Organization Registry - "Ποιός κάνει τί και πού". Επιτρέπει στα "γραφεία ανακούφισης" (relief agencies) να κατευθύνουν τις δραστηριότητές τους.
* Ticketing - Master Message Log to process incoming reports & requests.
* Μυνήματα - Στέλνει και παραλαμβάνει μυνήματα μέσω ηλεκτρονικού ταχυδρομείου και κινητού τηλεφώνου.
* Βιβλιοθήκη εγγράφων - Μία βιβλιοθήκη ηλεκτρονικών πηγών, οπως αρχεία εικόνων και εγγράφων (office documents).
* Συμβατότητα με το Ushahidi (Integration) - Έχει τη δυνατότητα να integrate δεδομένα από το Ushahidi 
