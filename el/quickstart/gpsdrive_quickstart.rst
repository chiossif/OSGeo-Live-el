...
~~~~~~~~~~~~~~~~~~~~~~~
Πέρα απ' τις επιλογές στο Preferences menu και τις διαφορετικές καταστάσεις λειτουργίας
...
Απόδοση δεδομένων OpenStreetMap μέσω Mapnik
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Εαν έχετε εκτελέσει μια τοπική βάση δεδομένων PostGIS (για παράδειγμα μία σαν αυτή που
παρέχεται με αυτό το Live DVD) μπορείτε να ενεργοποιήσετε την απόδοση δεδομένων από το 
...
Για να το ανοίξετε πρέπει να ανοίξετε σαν υπερχρήστης(root) το αρχείο
