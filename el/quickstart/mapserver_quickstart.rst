...
.. Οδηγός γρήγορης εκίνησης mapserver:
...
Ο MapServer είναι ένα λογισμικό ανοικτού κώδικα <http://www.opensource.org>`_ geographic απόδοσης γεωγραφικών δεδομένων. Σας επιτρέπει να δημιουργήσετε "εικόνες γεωγραφικών χαρτών".
