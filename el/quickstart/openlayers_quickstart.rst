...
**Ex. 1**: Δημιουργώντας την πρώτη σας HTML σελίδα   
...
**Ex. 2:** Κατασκευαστής χάρτη

Το επόμενο βήμα στη δημιουργία ενός viewer είναι η προσθήκη ενός Layer στο χάρτη.
Το OpenLayers υποστηρίζει διάφορες πηγές δεδομένων, από το WMS μέχρι το Yahoo! Χάρτες
στο WorldWind. Σε αυτό το παράδειγμα, χρησιμοποιείται το WMS layer. Το WMS layer είναι ένα παράδειγμα που το παρέχει η MetaCarta.
...
**Ex. 3:** Κατασκευαστής Layer

Η πρώτη παράμετρος σε αυτό τον κατασκευαστή είναι το όνομα του Layer,
το οποίο χρησιμοποιείται για μερικούς σκοπούς προβολής. Η δεύτερη παράμετρος είναι το URL του κατανεμητή WMS.
Η τρίτη παράμετρος είναι ένα αντικείμενο που περιέχει τις παραμέτρους που θα επισυναπτούν στην όταν ζητείται το WMS.
...
+++++++++++++++++++++++
Το ακόλουθο τμήμα κώδικα τοποθετεί όλα τα τμήματα μαζί για να δημιουργήσει έναν OpenLayers viewer.
...
**Ex. 4:** Πλήρης HTML και Javascript για έναν απλό WMS περιηγητή

Προσθέτοντας ένα WMS επίθεμα
---------------------

Τα WMS layers έχουν τη δυνατότητα να επικαλύπτονται από άλλα  WMS layers που βρίσκονται στην ίδια προβολή. Υπάρχουν διάφοροι τρόποι για να επισημανθεί ένα Layer ως επίθεμα, αντί ως βάση,
rather than a base layer. Με το WMS, ο καλύτερος τρόπος να γίνει αυτό, είναι θέτοντας στην παράμετρο transparent' (διαφάνεια) την τιμή 'true'. Το παράδειγμα εδώ χρησιμοποιεί ένα WMS που αναπαριστά τα σύνορα των κρατών,για να επιδείξει την επιθεση ενός διαφανούς WMS.
...
**Ex. 5:** Πώς να προσθέσετε ένα διαφανές WMS επίθεμα στο χάρτη σας.
